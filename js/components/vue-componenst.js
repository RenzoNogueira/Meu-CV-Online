...
Vue.component('links-menu', {
    template: `
    <div>
        <a onClick="app.togleMobileMenu()" class="text-sm-center nav-link text-light" aria-current="page"
            href="#section-hi">Olá</a>
        ...
        <div class="dropdown">
            <span class="cursor text-sm-center nav-link text-light dropdown-toggle" id="dropdownMenuButton2"
